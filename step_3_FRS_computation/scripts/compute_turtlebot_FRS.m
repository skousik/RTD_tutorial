...
% if degree == 4, make the distance scale larger, otherwise the
% conservatism will drive the FRS out of [-1,1]^2
if degree == 4
    disp(['Increasing distance scale for degree 4 solution to keep FRS ',...
        'in the [-1,1] box!'])
